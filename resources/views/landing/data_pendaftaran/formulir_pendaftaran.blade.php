        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Program ACC</span> <i
                                class="bi bi-chevron-down dropdown-indicator"></i></a>
                        <ul>
                            <li><a href="#">Program Magang Jepang</a></li>
                            <li><a href="#">Program Tokutei Ginou</a></li>
                            <li><a href="#">Program Matching Job</a></li>
                        </ul>
                    </li>
                    <li class="dropdown"><a href="#"><span>Social Media</span> <i
                                class="bi bi-chevron-down dropdown-indicator"></i></a>
                        <ul>
                            <li><a href="https://www.facebook.com/amanahcitracemerlangjapan?mibextid=ZbWKwL"
                                    target="_blank">Facebook
                                    ACC Japan Centre</a></li>
                            <li><a href="https://www.instagram.com/official_accjapancentre/" target="_blank">Instagram
                                    ACC Japan Centre</a></li>
                            <li><a href="https://wa.me/6285640110822" target="_blank">WhatsApp Japan</a></li>
                            <li><a href="https://www.youtube.com/@AmanahCitraCemerlang" target="_blank">YouTube ACC</a>
                            </li>
                        </ul>
                    </li>
                    <li><a href="/#galeri">Galeri ACC</a></li>
                </ul>
            </nav>
        ...
        <div class="min-h-screen pb-12">
            <section id="hero"
                ...
                <div class="registration-hero-content container relative z-10 mx-auto px-4 text-white">
                    ...
                    <h2
                        class="text-2xl md:text-4xl font-bold tracking-tight mb-3 uppercase drop-shadow-md justify-center">
                    ...
                    <form class="signup-form space-y-8" id="pendaftaranForm">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    <label class="block text-sm font-medium text-gray-700 mb-1">NAMA LENGKAP
                                        (INDONESIA)
                                    ...
                                    <p class="text-xs text-amber-600 font-medium mt-1">Wajib menggunakan huruf KAPITAL.
                                    </p>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text"
                                        ...
                                        required>
                                    <p class="text-xs text-amber-600 font-medium mt-1">Gunakan huruf KAPITAL. Contoh:
                                        JL.
                                        BAWAL
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">MINUS MATA
                                        KANAN</label>
                                    <input type="text"
                                        class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm text-gray-800"
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">SIFAT /
                                        KEPRIBADIAN</label>
                                    <input type="text"
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                        ...
                                        name="hobi" id="hobi" placeholder="Contoh: sepak bola, catur"
                                        required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                        ...
                                        name="motivasi" id="motivasi"
                                        placeholder="Contoh: Membantu ekonomi orang tua" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 border-b pb-2 mb-5 flex items-center">
                                <span class="w-2 h-6 bg-amber-500 rounded mr-2"></span> Rencana & Komitmen Kerja di
                                Jepang
                            </h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">TARGET MENABUNG SELAMA
                                        3
                                        TAHUN
                                        <span class="text-red-500">*</span></label>
                                    <select
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">RENCANA SETELAH KEMBALI
                                        KE
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">PERNAH TINGGAL/BEKERJA
                                        DI
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">JIKA YA, APA
                                        KUALIFIKASI
                                        YANG
                                        DILAMAR?</label>
                                    <textarea
                        ...
                        <div>
                            ...
                            <div class="space-y-6 bg-gray-50/50 p-4 md:p-6 rounded-xl border border-gray-100">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        <label class="block text-xs font-semibold text-gray-600 uppercase mb-1">Tahun
                                            Masuk
                                            <span class="text-red-500">*</span></label>
                                        <input type="number"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                                <div class="bg-blue-50/40 p-4 rounded-xl border border-blue-100/50">
                                    <label class="block text-sm font-semibold text-blue-900 mb-1">Perguruan Tinggi
                                        (Jika
                                        Ada)</label>
                                    <p class="text-xs text-blue-700/70 mb-3">Maksimal 2 data, gunakan huruf kapital.
                                    </p>
                                ...
                                <div class="bg-teal-50/40 p-4 rounded-xl border border-teal-100/50">
                                    <label class="block text-sm font-semibold text-teal-900 mb-1">Riwayat Pengalaman
                                        Kerja</label>
                                    <p class="text-xs text-teal-700/70 mb-3">Maksimal 3 pengalaman, gunakan huruf
                                        kapital.
                                    </p>
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 border-b pb-2 mb-5 flex items-center">
                                <span class="w-2 h-6 bg-emerald-500 rounded mr-2"></span> Kompetensi Bahasa &
                                Pengalaman
                                Internasional
                            </h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">BAHASA ASING YANG
                                        DIKUASAI
                                        <span class="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">JIKA NEGARA LAIN,
                                        SEBUTKAN
                                        NAMA
                                        NEGARA</label>
                                    <input type="text"
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">BERSEDIA BELAJAR BAHASA
                                        DI
                                        LPK
                                ...
                                <div>
                                    ...
                                    <input type="number"
                                        class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm text-gray-800"
                                        name="bab_yang_dipelajari"
                                        placeholder="Contoh: 25 (Kosongkan jika belum pernah)">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <div class="md:col-span-3">
                                    <p class="text-xs font-bold text-gray-500 uppercase tracking-wider">Informasi Ayah
                                    </p>
                                </div>
                                <div>
                                    <input type="text"
                            ...
                            <div
                                class="grid grid-cols-1 md:grid-cols-3 gap-4 bg-gray-50/50 p-4 rounded-xl border border-gray-100 mb-6">
                                <div class="md:col-span-3">
                                    <p class="text-xs font-bold text-gray-500 uppercase tracking-wider">Informasi Ibu
                                    </p>
                                </div>
                                <div>
                                    <input type="text"
                            ...
                            <div class="bg-rose-50/40 p-4 rounded-xl border border-rose-100/50 mb-6">
                                <label class="block text-sm font-semibold text-rose-900 mb-1">Data Saudara
                                    Kandung</label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">APAKAH KELUARGA
                                        MENYETUJUI
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">NOMOR SEPATU (UKURAN)
                                        <span class="text-red-500">*</span></label>
                                    <input type="number"
                                        class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm text-gray-800"
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">PILIHAN SESI KELAS
                                        <span class="text-red-500">*</span></label>
                                ...
                                <div class="md:col-span-2">
                                    <label class="block text-sm font-medium text-gray-700 mb-1">PILIHAN PROGRAM UTAMA
                                        <span class="text-red-500">*</span></label>
                                    <select name="pilih_program"
                                        ...
                                        <option value="Program Matching Job Magang">Program Matching Job Magang
                                        </option>

...
<head>
    ...
    <title>Register - LPK ACC Asia Jaya</title>

    <meta name="description" content="" />

    <link rel="icon" type="image/png" href="{{ asset('tamplate_login/assets/img/logo.jpg') }}" />
                ...
                <div class="card">
                    <div class="card-body">
                        <center>
                            ...
                            <p class="mb-4">Welcome to Register Page!</p>
                        </center>
                        <form class="mb-3" action="{{ url('/actionregister') }}" method="POST">
                            @if (session('error'))
                            ...
                            <div class="mb-3 form-password-toggle">
                                <div class="d-flex justify-content-between">
                                    <label class="form-label" name="password_confirmation"
                                        for="password_confirmation" placeholder="Enter your password" required>Re
                                        Password</label>
                                </div>
                                <div class="input-group input-group-merge">

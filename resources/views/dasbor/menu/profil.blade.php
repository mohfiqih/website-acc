...
@section('title', 'LPK ACC Japan Centre - Profil')
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-column align-items-center text-center">
                        @if ($user->user_foto)
                            <img src="{{ asset($user->user_foto) }}" alt="{{ $user->name }}" class="rounded-circle"
                                width="150">
                        @else
                        ...
                        <div class="mt-3">
                            <h4>{{ $user->name }}</h4>
                            <p class="text-secondary mb-1">{{ $user->user_level }}</p><br />
                            <input type="file" class="form-control" aria-label="Sizing example input"
                                aria-describedby="inputGroup-sizing-sm" name="">
                        </div>
                    </div>
                </div>
            </div>
